...
Starting from the track templates in _Track_Preparation/tracks_templates_, they generate the files in the _media/tracks_ folder _track.png_, _track_info.npy_, and _track_map.npy_ needed by track.py.
